                ...
                <div class="col-md-6 col-sm-8">
                  <div class="profile_wrap">
                    <form name="chngpwd" method="post" onSubmit="return valid();">
                      ...
                      <?php if ($error) { ?><div class="errorWrap"><strong>Виникли певні проблеми</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>Успіх!</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                      <div class="form-group">
                        <label class="control-label">Теперішній пароль</label>
                      ...
                      <div class="form-group">
                        <label class="control-label">Підтвердження нового паролю</label>
                        <input class="form-control white_bg" id="confirmpassword" type="password" name="confirmpassword" required>
                      </div>

                      <div class="form-group">
                        <input type="submit" value="Оновити" name="updatepass" id="submit" class="btn btn-block">
                      </div>
                    </form>
                  </div>
                </div>
