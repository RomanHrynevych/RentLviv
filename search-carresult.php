...
<head>
  ...
  <title>RentLviv | Результати Пошуку</title>
  <!--Bootstrap -->
        ...
        <div class="col-md-9 col-md-push-3">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $cnt = $query->rowCount();
              ?>
              <p><span>Знайдено <?php echo htmlentities($cnt); ?> Авто</span></p>
            </div>
          </div>
            ...
            foreach ($results as $result) {  ?>
              <div class="product-listing-m gray-bg">
                ...
                <div class="product-listing-content">
                  ...
                  <p class="list-price">$<?php echo htmlentities($result->PricePerDay); ?> / День</p>
                  <ul>
                  ...
                  <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>" class="btn">Детальніше <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                </div>
              </div>
          <?php }
          } ?>
        ...
        <aside class="col-md-3 col-md-pull-9">
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-filter" aria-hidden="true"></i> Знайти Авто </h5>
            </div>
              ...
              <form action="search-carresult.php" method="post">
                ...
                <div class="form-group select">
                  <select class="form-control" name="fueltype">
                    <option>Виберіть тип палива</option>
                    <option value="Petrol">Бензин</option>
                    <option value="Diesel">Дизельне паливо</option>
                    <option value="CNG">Електрика</option>
                  </select>
                </div>

                <div class="form-group">
                  <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i>Пошук Авто</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-car" aria-hidden="true"></i> Останні додані </h5>
            </div>
                  ...
                  foreach ($results as $result) {  ?>
                    ...
                    <li class="gray-bg">
                      ...
                      <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->BrandName); ?>, <?php echo htmlentities($result->VehiclesTitle); ?></a>
                        <p class="widget_price">$<?php echo htmlentities($result->PricePerDay); ?> / День</p>
                      </div>
                    </li>
                <?php }
                } ?>
