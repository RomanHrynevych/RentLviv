              ...
              <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-6 col-sm-8">
                  <div class="profile_wrap">
                    <h5 class="uppercase underline">Налаштування профілю</h5>
                    <?php
                    if ($msg) { ?><div class="succWrap"><strong>Успіх</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                    <form method="post">
                      ...
                      <?php if ($result->UpdationDate != "") { ?>
                        <div class="form-group">
                          <label class="control-label">Останнє оновлення -</label>
                      ...
                      <div class="form-group">
                        <label class="control-label">Адреса e-mail</label>
                      ...
                      <div class="form-group">
                        <label class="control-label">Дата народження&nbsp;(день/місяць/рік)</label>
                        <input class="form-control white_bg" value="<?php echo htmlentities($result->dob); ?>" name="dob" placeholder="день/місяць/рік" id="birth-date" type="text">
                      </div>
                      <div class="form-group">
                        <label class="control-label">Твоя адреса</label>
                  ...
                  <div class="form-group">
                    <button type="submit" name="updateprofile" class="btn">Зберегти зміни <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                  </div>
                    </form>
                  </div>
                </div>
