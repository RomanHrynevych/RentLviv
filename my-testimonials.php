              ...
              <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-8 col-sm-8">
                  ...
                  <div class="profile_wrap">
                    <h5 class="uppercase underline">Мої Відгуки</h5>
                          ...
                          foreach ($results as $result) { ?>
                            ...
                            <li>
                              ...
                              <div>
                                ...
                                <p><b>Дата розміщення:</b><?php echo htmlentities($result->PostingDate); ?> </p>
                              </div>
                              <?php if ($result->status == 1) { ?>
                                <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Активне</a>

                                  <div class="clearfix"></div>
                                </div>
                              <?php } else { ?>
                                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Очікуємо</a>
                                  <div class="clearfix"></div>
                                </div>
                              <?php } ?>
                            </li>
