          ...
          <div class="listing_detail_head row">
            ...
            <div class="col-md-3">
              <div class="price_info">
                <p>$<?php echo htmlentities($result->PricePerDay); ?> </p>За 1 День
              </div>
            </div>
          </div>
          <div class="row">
              ...
              <div class="main_features">
                <ul>
                  ...
                  <li> <i class="fa fa-user-plus" aria-hidden="true"></i>
                    <h5><?php
                        echo htmlentities($result->SeatingCapacity);
                        ?></h5>
                    <p><?php
              ...
              <div class="listing_more_info">
                <div class="listing_detail_wrap">
                  ...
                  <ul class="nav nav-tabs gray-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Короткий Опис</a></li>

                    <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Аксесуари</a></li>
                  </ul>
                    ...
                    <div role="tabpanel" class="tab-pane" id="accessories">
                      ...
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Антиблокувальна система гальм (ABS)</td>
                          ...
                          <tr>
                            <td>Плеєр для компакт-дисків (Bluetooth)</td>
                          ...
                          <tr>
                            <td>Електроприводи дверних замків</td>
                          ...
                          <tr>
                            <td>Подушка безпеки пасажира</td>
          ...
          <?php }
            ...
            <aside class="col-md-3">
              ...
              <div class="share_vehicle">
                <p>Link: <a href="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
              </div>
              ...
              <?php if ($_SESSION['login']) { ?>
                <div class="sidebar_widget">
                  <div class="widget_heading">
                    <h5><i class="fa fa-envelope" aria-hidden="true"></i>Замовити зараз</h5>
                  </div>
                  <form method="post">
                    <div class="form-group">
                      <label>Від: (виберіть дату)</label>
                      <input type="date" class="form-control" name="fromdate" placeholder="From Date" required>
                    </div>
                    <div class="form-group">
                      <label>До: (виберіть дату)</label>
                      <input type="date" class="form-control" name="todate" placeholder="To Date" required>
                    </div>
                    <div class="form-group">
                      <textarea rows="4" class="form-control" name="message" style="resize: none;" placeholder="Повідомлення" required></textarea>
                    </div>
                    <div class="form-group">
                      <input type="submit" class="btn" style="width: 100%;" name="submit" value="Замовити">
                    </div>
                  </form>
                </div>
              <?php } else { ?>
                <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Авторизуватись</a>
              <?php }  ?>
            </aside>
            <!--/Side-Bar-->
          </div>
